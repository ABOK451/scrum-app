  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: Color.fromARGB(255, 200, 0, 255), // Color púrpura personalizado
      ),
          ...
          if (snapshot.connectionState == ConnectionState.waiting) {
            return Center(
              child: CircularProgressIndicator(
                valueColor: AlwaysStoppedAnimation<Color>(Color.fromARGB(255, 166, 0, 255)), // Color morado personalizado
              ),
            );
            ...
            return Center(
              child: Text(
                ...
                style: TextStyle(color: Color.fromARGB(255, 255, 0, 230)), // Color magenta personalizado
              ),
            );
          } else {
            ...
            return ListView.builder(
              ...
              itemBuilder: (BuildContext context, int index) {
                return GestureDetector(
                  ...
                  child: Card(
                    color: Colors.orange[50], // Color naranja claro
                    elevation: 2,
                    margin: EdgeInsets.symmetric(horizontal: 10, vertical: 5),
                    child: ListTile(
                      title: Text(
                        items[index].name,
                        style: TextStyle(color: Color.fromARGB(255, 255, 0, 157)), // Color rosa personalizado
                      ),
                    ),
                  ),
                );
