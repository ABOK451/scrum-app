          ...
          if (snapshot.connectionState == ConnectionState.waiting) {
            return Center(
              child: CircularProgressIndicator(
                valueColor: AlwaysStoppedAnimation<Color>(Colors.deepPurple), // Cambia el color del indicador de carga
              ),
            );
            ...
            return ListView.builder(
              ...
              itemBuilder: (BuildContext context, int index) {
                return Card(
                  color: Colors.deepPurple[100], // Cambia el color de fondo de la tarjeta
                  elevation: 2,
